    ...
    $(this).dropdown('toggle')
        ...
        <!-- Formulaire--> 
          <div class="row">
                ...
                <div class="col-6">
                   <h2 class="text-center text-info mt-5 mb-5">Inscription</h2>
                   <form class="bg-primary rounded ">
                        <div class="form-group row">
                            <label for="staticEmail" class="col-sm-2 col-form-label text-secondary font-weight-bold">
                             Nom
                            </label>
                            <div class="col-sm-7">
                            <input type="text" class="form-control form-control-sm" id="inputPassword" placeholder="THIOR">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="inputPassword" class="col-sm-2 col-form-label text-secondary font-weight-bold">
                             Prénom
                            </label>
                            <div class="col-sm-7">
                            <input type="text" class="form-control form-control-sm" id="inputPassword" placeholder="Ousmane">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-7">
                            <input type="text" class="form-control form-control-sm" id="inputPassword" placeholder="00edhjh45">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="inputPassword" class="col-sm-2 col-form-label text-secondary font-weight-bold">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-7">
                            <input type="text" class="form-control form-control-sm" id="inputPassword" placeholder="77 777 77">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="inputPassword" class="col-sm-2 col-form-label text-secondary font-weight-bold">
