...
-- Généré le :  Mar 15 Octobre 2019 à 10:13
...
--
-- Structure de la table `lisappdev`
--

CREATE TABLE `lisappdev` (
...
--
-- Structure de la table `listappref`
--

CREATE TABLE `listappref` (
  `matricule` int(11) NOT NULL,
  `prenom` varchar(50) NOT NULL,
  `nom` varchar(50) NOT NULL,
  `email` varchar(50) NOT NULL,
  `referentiel` int(50) NOT NULL,
  `cinpasseport` varchar(50) NOT NULL,
  `telephone` varchar(50) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
--
-- Index pour la table `lisappdev`
--
ALTER TABLE `lisappdev`
  ADD PRIMARY KEY (`matricule`);

--
-- Index pour la table `listappref`
--
ALTER TABLE `listappref`
  ADD PRIMARY KEY (`matricule`);
...
--
-- AUTO_INCREMENT pour la table `lisappdev`
--
ALTER TABLE `lisappdev`
  MODIFY `matricule` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT pour la table `listappref`
--
ALTER TABLE `listappref`
  MODIFY `matricule` int(11) NOT NULL AUTO_INCREMENT;
--
